...
#define __PYX_HAVE__Experiments____init__
#define __PYX_HAVE_API__Experiments____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'Experiments.__init__' */
#define __Pyx_MODULE_NAME "Experiments.__init__"
int __pyx_module_is_main_Experiments____init__ = 0;

/* Implementation of 'Experiments.__init__' */
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static char __pyx_k_Experiments[] = "Experiments";
static PyObject *__pyx_n_u_Experiments;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_u_Experiments, __pyx_k_Experiments, sizeof(__pyx_k_Experiments), 0, 1, 0, 1},
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_Experiments____init__) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_Experiments) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if PY_MAJOR_VERSION >= 3
  {
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Experiments.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Experiments.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
