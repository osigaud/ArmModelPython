...
#define __PYX_HAVE__ArmModel____init__
#define __PYX_HAVE_API__ArmModel____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'ArmModel.__init__' */
#define __Pyx_MODULE_NAME "ArmModel.__init__"
int __pyx_module_is_main_ArmModel____init__ = 0;

/* Implementation of 'ArmModel.__init__' */
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static char __pyx_k_ArmModel[] = "ArmModel";
static PyObject *__pyx_n_u_ArmModel;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_u_ArmModel, __pyx_k_ArmModel, sizeof(__pyx_k_ArmModel), 0, 1, 0, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initArmModel(void); /*proto*/
PyMODINIT_FUNC initArmModel(void)
#else
PyMODINIT_FUNC PyInit_ArmModel(void); /*proto*/
PyMODINIT_FUNC PyInit_ArmModel(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_ArmModel(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ArmModel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_ArmModel____init__) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_ArmModel) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "ArmModel")) {
      if (unlikely(PyDict_SetItemString(modules, "ArmModel", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ArmModel.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ArmModel.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
